...
for i in {500,1000,8000,16000,32000,64000}
#for i in {500,1000}
do
...
VALUES0=( sgraph_bellman_ford ) # sgraph_bellman_ford sgraph_bfs sgraph_teenage_follower   sgraph_page_rank
VALUES1=( default )
VALUES2=( $i ) # 8000 16000 32000 64000 ) # Graph Size
...
mv ~/Desktop/simulator/SMCSim/SMC-WORK/scenarios/01/*/m5out/stats.txt ~/Desktop/simulator/SMCSim/Statistics/stats_${V1}_${V2}.txt
~/Desktop/simulator/SMCSim/Statistics/pull_stats stats_${V1}_${V2}.txt short_stats_${V1}_${V2}.txt
