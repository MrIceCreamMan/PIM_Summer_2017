...
echo "  Which data structure to be tested?\n";
echo "  Type in the number for the coresponding data structure:\n\n";
echo "    1 = MyFCLinkedList, 2 = MyFCSkipList, 3 = MyFCQueue\n";
echo "    4 = FCQueue,        5 = FC_Research\n\n";
echo "  My choice:";
read choice;
